...
/*   Updated: 2025/03/28 16:07:41 by tblochet             ┴ ┴┴ ┴ ┴ ┴ ┴        */
/*                                                                            */
/* ************************************************************************** */
...
void Contact::lastname(std::string newLastname)
{
...
void Contact::firstname(std::string newFirstname)
{
...
void Contact::nickname(std::string newNickname)
{
...
void Contact::secret(std::string newSecret)
{
...
void Contact::number(std::string newNumber)
{
...
void Contact::initialized(bool state)
{
